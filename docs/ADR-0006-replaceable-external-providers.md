...
An external identity is mapped to an application user using an identity source plus the provider subject. The identity source is configuration, not a hard-coded vendor name.
