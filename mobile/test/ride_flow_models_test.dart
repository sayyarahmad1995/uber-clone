...
void main() {
  test('parses pending driver offer', () {
    ...
    expect(offer.fare.currency, 'PKR');
  ...
  test('keeps completed Trip and cash settlement independent', () {
    ...
    expect(trip.settlement.method, 'cash');
  });

  test('parses expired marketplace request and nullable own offer', () {
    ...
    expect(request.expiresAt, DateTime.parse('2026-09-15T10:10:00Z'));
    expect(request.responseDeadline, DateTime.parse('2026-09-15T10:02:00Z'));
  });

  test('parses nullable driver location in Rider snapshot', () {
